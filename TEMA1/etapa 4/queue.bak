...
(define (queue-empty? q)
  (if (and (zero? (queue-size-l q)) (zero? (queue-size-r q))) #t #f)) 
...
(define (enqueue x q)
  (if (<= (+ (queue-size-r q) 1) (queue-size-l q))
      (make-queue (queue-left q) (cons x (queue-right q)) (queue-size-l q) (+ 1 (queue-size-r q)))
      (make-queue (rotate (queue-left q) (cons x (queue-right q)) empty-stream) '() (+(+ (queue-size-l q) (queue-size-r q)) 1) 0)))
...
(define (dequeue q)
  (if (>= (- (queue-size-l q) 1) (queue-size-r q))
      (make-queue (stream-rest (queue-left q)) (queue-right q) (- (queue-size-l q) 1) (queue-size-r q))
      (make-queue (rotate (stream-rest (queue-left q)) (queue-right q) empty-stream) '() (- (+ (queue-size-l q) (queue-size-r q)) 1) 0)))
